...
export type IncFactory = {
  ...
  instructions: [
    {
      name: "createCompany";
      discriminator: [36, 192, 217, 147, 233, 129, 198, 18];
      accounts: [
        {
    ...
    },
    {
      ...
      discriminator: [197, 60, 118, 177, 172, 48, 68, 194];
      accounts: [
        {
          name: "companyRegistry";
        }
    ...
    {
      name: "getCompanyList";
      discriminator: [51, 248, 58, 75, 239, 203, 29, 217];
      accounts: [
        {
          name: "companyRegistry";
        }
  ...
  accounts: [
    {
      name: "company";
      discriminator: [32, 212, 52, 137, 90, 7, 206, 183];
    },
    {
      name: "companyRegistry";
      discriminator: [27, 30, 241, 213, 171, 175, 54, 176];
    }
  ];
  errors: [
    {
